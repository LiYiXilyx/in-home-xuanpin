export function createCatalogApi({fetchImpl=globalThis.fetch}={}){
  ...
  return{
    imageExportHistory:()=>request('/api/catalog/exports/images/history'),
    chooseImageFolder:()=>request('/api/catalog/exports/images/choose-folder',{method:'POST',body:{}}),
    openImageFolder:()=>request('/api/catalog/exports/images/open-folder',{method:'POST',body:{}}),
    exportImages:body=>request('/api/catalog/exports/images',{method:'POST',body}),
    openExportFolder:()=>request('/api/catalog/exports/open-folder',{method:'POST',body:{}}),
    pauseInitial:(id,body)=>request(`/api/catalog/operator/initial-campaigns/${encodeURIComponent(id)}/pause`,{method:'POST',body}),
