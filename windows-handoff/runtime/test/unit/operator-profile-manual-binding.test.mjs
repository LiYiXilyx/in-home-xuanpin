...
function evidence(overrides={}){return{profile,domEvidence:{url:'https://www.temu.com/de-en/pet-supplies.html?sort=top',siteCountry:'DE',language:'en',currency:'EUR',category:'Pets',breadcrumbs:['Home & Pet','Pet Supplies'],sortOrder:'Top Sales',cardCount:10,ready:true,...overrides},networkEvidence:{ready:true}};}
