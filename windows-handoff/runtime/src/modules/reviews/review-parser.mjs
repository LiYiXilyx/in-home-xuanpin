...
export function parseReviewCard(card,{ productId,goodsId,sourceUrl,capturedAt=new Date().toISOString(),now=new Date(),allowRatingOnly=false }) {
  ...
  if (!content && !reviewId && !allowRatingOnly) errors.push('EMPTY_REVIEW_WITHOUT_ID');
