...
export function resolveCaptureTransportPolicy({campaign={},profile={}}={}){
  ...
  if(profile.profile_kind==='CAPTURE_ONLY'&&['initial','expansion'].includes(campaign.campaignType)&&campaign.browserControlMode==='MANUAL_BIND_PASSIVE_CAPTURE')return{policy:DOM_REQUIRED_NETWORK_OPTIONAL,source:'DERIVED_CAPTURE_ONLY_INITIAL_V1'};
