...
const paths=sourcingRuntimePaths({runId:args.runId});console.log(JSON.stringify(await createInputPackage({runId:args.runId,gitCommit:git.commit,goods,inputDir:paths.inputDir}),null,2));
