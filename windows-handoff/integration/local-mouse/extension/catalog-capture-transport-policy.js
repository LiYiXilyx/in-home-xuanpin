...
(() => {
  ...
  function resolveCaptureTransportPolicy({campaign={},profile={}}={}){
    ...
    if(profile.profile_kind==='CAPTURE_ONLY'&&['initial','expansion'].includes(campaign.campaignType)&&campaign.browserControlMode==='MANUAL_BIND_PASSIVE_CAPTURE')return Object.freeze({policy:DOM_OPTIONAL,source:'DERIVED_CAPTURE_ONLY_INITIAL_V1'});
