...
test('extension does not request or access browser secrets',() => {
  const files=['manifest.json','background.js','catalog-parser.js','catalog-capture.js','catalog-overlay-mode.js','catalog-breadcrumbs.js','catalog-operator-view-model.js','catalog-operator-overlay.js','catalog-popup-view.js','catalog-manual-binding.js','catalog-manual-passive-runner.js','catalog-auto-runner.js','temu-market-evidence.js','content-script.js','popup.js','temu-network-interceptor.js','catalog-network-bridge.js'].map(name => fs.readFileSync(path.join(root,'browser-extension',name),'utf8')).join('\n');
