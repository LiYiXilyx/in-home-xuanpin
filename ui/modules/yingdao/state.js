const STATE_KEYS=new Set(['currentRun','selectedTask','loading','error','progress','random5','imageCache','exportStatus','importStatus','scanStatus','reviewSummary','settings','scanToken','preview','mounted','lastRefreshedAt']);

export function createYingdaoState(){return{
  currentRun:null,selectedTask:null,loading:{settings:false,scan:false,import:false,retry:false,review:false},error:null,
